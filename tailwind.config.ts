  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'scale-in-center': 'scaleInCenter 0.3s cubic-bezier(0.4, 0, 0.2, 1)',
      ...
      boxShadow: {
        ...
        'glow-accent': '0 0 30px rgba(14, 165, 233, 0.5)',
        ...
        'soft-lg': '0 4px 25px -5px rgba(0, 0, 0, 0.1), 0 20px 40px -5px rgba(0, 0, 0, 0.08)',
        'soft-xl': '0 8px 40px -8px rgba(0, 0, 0, 0.12), 0 25px 50px -8px rgba(0, 0, 0, 0.1)',
